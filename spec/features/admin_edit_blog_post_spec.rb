...
feature 'Admin edit Post Post' do
  scenario 'successfully' do
    ...
    expect(page).to have_css('a', text: "Criado em: #{post.created_at.strftime('%B %d, %Y')}")
    expect(page).to have_css('a', text: "Atualizado em: #{post.updated_at.strftime('%B %d, %Y')}")
  ...
  scenario 'but fields are blank' do
    ...
    expect(page).to have_current_path(backoffice_post_path(post))
